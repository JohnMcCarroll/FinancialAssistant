...
# 3. Create a UTF8 encoder WITHOUT a BOM
$utf8NoBom = New-Object System.Text.UTF8Encoding($false)

# 4. Write the file
[System.IO.File]::WriteAllText($envFilePath, "VITE_QUERY_URL=$QueryUrl`n", $utf8NoBom)

Write-Host "Injected clean UTF-8 URL to .env.local" -ForegroundColor Green
